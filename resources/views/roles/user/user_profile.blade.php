            ...
            <div class="col-12 col-md-4 col-lg-3">
                <div class="card shadow-sm text-center h-100 border-0 rounded-4">
                    <div class="card-body p-4">
                        ...
                        <h5 class="fw-bold text-dark mt-3">{{ $user->name }}</h5>
                        ...
                        <hr class="my-3">
                        <a href="{{ route('user.edit.profile') }}" class="btn btn-outline-success btn-sm w-100 rounded-pill">
                ...
                <div class="card shadow-sm h-100 border-0 rounded-4">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-7 fw-semibold">{{ $user->created_at->format('d M Y') }}</div>
                        </div>
                    </div>
                </div>
            </div>
