...
<div class="sidebar" id="sidebar">
    ...
    <a href="{{ route('burial.request.index') }}" class="{{ request()->routeIs('burial.request.index') ? 'active' : '' }}" style="color: black;"><i class="bi bi-person-gear me-2"></i><span>Request Burial</span></a>
